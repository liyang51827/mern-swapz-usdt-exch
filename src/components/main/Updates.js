          ...
          <TabPanel value={tabIndex} index={0}>
            <Stack spacing={1}>
              ...
              <Typography variant='body2'>
                The only official URL for Swapz is https://trading.swapz.app. Bookmark it once and use the bookmark.
              </Typography>
              <Typography variant='body2'>
              ...
              <Typography variant='body2'>
                The only official representatives in the chat room are SWAPZ_TWITTER, WAPZREP1_TWITTER, ETHERDELTAREP2_TWITTER, ETHERDELTAREP3_TWITTER, ETHERDELTAREP4_TWITTER, and ETHERDELTAUX_TWITTER.
              </Typography>
              <Typography variant='body2' color='error.main'>
                Disclaimer
              </Typography>
              <Typography variant='body2'>
                SWAPZ is a decentralized trading platform that lets you trade Ether and Ethereum-based tokens directly with other users. You are responsible for your own account, funds, and private keys. You are responsible for your own trading decisions, and the details and mechanics of the tokens you trade. EtherDelta is not responsible for your decisions, actions, or losses that result from using EtherDelta. EtherDelta makes no guarantee about the tokens that you trade using EtherDelta. EtherDelta does not hold your funds and does not offer refunds. While the information contained on EtherDelta is periodically updated, no guarantee is given that the information provided on EtherDelta is correct, complete, or up-to-date. By using EtherDelta, you acknowledge this and agree to these terms.
              </Typography>
            </Stack>
          </TabPanel>
